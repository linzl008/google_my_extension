    ...
    export default {
        ...
        methods: {
            initRain() {
                ...
                canvasEl.height = window.document.body.clientHeight;
                ...
                function render() {
                    ...
                    linelist.forEach(function (line) {
                        ...
                        var grd = ctx.createLinearGradient(line.posx, line.posy, line.posx + line.h * speedx, line.posy + line.h); //线性渐变的起止坐标
                        var colors = [
                            '#8b8b8b',
                            '#c3c3c3',
                        ]
                    ...
                    // 解开注释，可看见鼠标范围
                    // if(!(mousePos[0]<= 0 || mousePos[0]>=canvasEl.width-mouseDis ||
                    //     mousePos[1]<= 0 || mousePos[1]>=canvasEl.height-mouseDis) ){
                    //     ctx.beginPath();
                    //     var my_gradient=ctx.createRadialGradient(mousePos[0], mousePos[1],0,mousePos[0], mousePos[1],mouseDis);
                    //     my_gradient.addColorStop(0,'#49e2bf');
                    //     my_gradient.addColorStop(0.5,"rgba(73,226,191,0.49)");
                    //     my_gradient.addColorStop(1,'#49e2bf00');
                    //     ctx.fillStroke=my_gradient;
